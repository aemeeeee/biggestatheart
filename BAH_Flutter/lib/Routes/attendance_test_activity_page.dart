...
class ActivityPageState extends State<ActivityPage> {
                        ...
                        Column(
                          children: [
                            ...
                            currActivityList.contains(widget.activityID)
                                ...
                                : enrollButton(context, widget.activityID),
                          ],
                        ),
                      ],
                    ))),
  ...
  Widget enrollButton(BuildContext context, String activityID) {
  return Container(
    ...
    child: ElevatedButton(
      onPressed: () async {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => AttendanceForm(activityID: widget.activityID),
          ),
        );
      },
      style: ButtonStyle(
